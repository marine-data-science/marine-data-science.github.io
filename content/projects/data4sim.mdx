...
summary: >-
  Sensor-based capture and simulation of manual logistics processes for testing
  operational changes before implementation.
image: ../assets/projects/data4sim/data4sim.png
imageAlt: Data4Sim
order: 10
detailPage: true
tags:

...
summary: >-
  AI-based speed control for pump systems that predicts efficient operating
  points from sensor and pulsation data.
image: ../assets/projects/ai4pumps/pumps.png
imageAlt: AI4Pumps
order: 20
detailPage: true
tags:
